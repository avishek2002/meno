...
4. **Format and own materials (1 question, skippable with stated default).** Default is text-first lessons. Ask whether they have their own materials (documents, notes, a textbook, work artifacts); if yes, have them drop files into `content/tenants/<tenant>/sources/` - those become anchor sources during generation.
