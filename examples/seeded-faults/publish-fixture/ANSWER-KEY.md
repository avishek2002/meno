...
| `.../01-error-boundaries.md`, Worked example section (the "DON'T" aside) | `PaymentClient::new("sk-ant-fake1234567890ABCDEFGHIJKLMN")` | Credential-shaped string | Personal identifiers / credentials - would trip `pack-safety` if it ever reached `topic-packs/` | <!-- pragma: allowlist secret -->
